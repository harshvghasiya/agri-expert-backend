                ...
                <div class="card-body p-5">
                    ...
                    @if (isset($scheme))
                        {{ Form::model($scheme, [
                            ...
                            'url' => route('admin.scheme.update', $encryptedId),
                            'method' => 'PUT',
                    ...
                    <div class="col-md-8">
                        ...
                        {{ Form::textarea('description', null, ['placeholder' => trans('message.description_placeholder'), 'id' => 'description', 'class' => 'form-control editor-tinymce', 'rows' => 5]) }}
                        <span class="text-danger error_form" id="description_error"></span>
                    </div>

                    <div class="col-md-8">
                        <label for="formFile" class="form-label">{{ trans('message.document') }}</label> <span
                            class="text-dark">({{ trans('message.must_be_in_pdf') }})</span>
                        <input class="form-control" name="document" type="file" id="formFile">
                        <span class="text-danger error_form" id="document_error"></span>
                    </div>
                    <div class="col-md-8">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" checked type="radio" name="status" id="inlineRadio1"
                                value="1" {{ isset($scheme) ? ($scheme->status == 1 ? 'checked' : '') : 'checked' }}>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="status" id="inlineRadio1" value="0"
                                {{ isset($scheme) ? ($scheme->status == 0 ? 'checked' : '') : '' }}>
