...
<head>
    ...
    @else
        <title>{{ trans('message.app_name') }}</title>
    @endif
    <style type="text/css">
        body {
            margin: 0;
                                    ...
                                    <div style="width:100% !important;">
                                        <div
                                            ...
                                            <div align="center" class="img-container center fixedwidth"
                                                ...
                                                <img align="center" alt="{{ trans('message.app_name') }}" border="0"
                                                    class="center fixedwidth" src="{{ $setting->logo }}"
                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 150px; display: block;"
                                                    title="{{ trans('message.app_name') }}" width="352" />
                                            </div>
                                            <?php
                                            
                                            echo htmlspecialchars_decode($email_body);
                                            ?>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        style="font-size: 12px; line-height: 1.2; word-break: break-word; text-align: left; font-family: inherit; mso-line-height-alt: 14px; margin: 0;">
                                                        <span
                                                            style="color: #95979c; font-size: 12px;">{{ trans('message.app_name') }}
