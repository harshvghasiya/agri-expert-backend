...
@section('title')
    @if ($title != null && $title != '')
        {{ $title }}
    @else
        {{ trans('message.mail_config_title') }}
                ...
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        @if (isset($mail_config))
                            {{ trans('message.mail_config_managment') }}
                        @else
                            {{ trans('message.add_mail_config_breadcrum') }}
                        @endif
                    </li>
                </ol>
            </nav>
        ...
        <div class="col-xl-6 mx-auto">
            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    ...
                    <div class="col-md-8">
                        <label for="from_mail" class="form-label">{{ trans('message.from_mail_label') }}</label> <span
                            class="text-danger">*</span>
                        {{ Form::text('from_mail', null, ['placeholder' => trans('message.from_mail_placeholder'), 'id' => 'from_mail', 'class' => 'form-control']) }}
                        <span class="text-danger error_form" id="from_mail_error"></span>

                    </div>
                    <div class="col-md-8">
                        <label for="smtp_host" class="form-label">{{ trans('message.smtp_host_label') }}</label> <span
                            class="text-danger">*</span>
                        {{ Form::text('smtp_host', null, ['placeholder' => trans('message.smtp_host_placeholder'), 'id' => 'smtp_host', 'class' => 'form-control']) }}
                        <span class="text-danger error_form" id="smtp_host_error"></span>

                    </div>
                    <div class="col-md-8">
                        <label for="smtp_port" class="form-label">{{ trans('message.smtp_port_label') }}</label> <span
                            class="text-danger">*</span>
                        {{ Form::text('smtp_port', null, ['placeholder' => trans('message.smtp_port_placeholder'), 'id' => 'smtp_port', 'class' => 'form-control']) }}
                        <span class="text-danger error_form" id="smtp_port_error"></span>

                    </div>
                    <div class="col-md-8">
                        <label for="encryption" class="form-label">{{ trans('message.encryption_label') }}</label> <span
                            class="text-danger">*</span>
                        {{ Form::text('encryption', null, ['placeholder' => trans('message.encryption_placeholder'), 'id' => 'encryption', 'class' => 'form-control']) }}
                        <span class="text-danger error_form" id="encryption_error"></span>

                    </div>
                    <div class="col-md-8">
                        <label for="smtp_username" class="form-label">{{ trans('message.smtp_username_label') }}</label>
                        ...
                        <span class="text-danger error_form" id="smtp_username_error"></span>

                    </div>
                    <div class="col-md-8">
                        <label for="smtp_password" class="form-label">{{ trans('message.smtp_password_label') }}</label>
                        <span class="text-danger">*</span>

                        <input class="form-control" placeholder="{{ trans('message.smtp_password_placeholder') }}"
                            id="smtp_password" type="password" name="smtp_password"
                            value="{{ \Crypt::encryptString($mail_config->smtp_password) }}">
                        <span class="text-danger error_form" id="smtp_password_error"></span>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" checked type="radio" name="smtp_status" id="inlineRadio1"
                                value="1"
                                {{ isset($mail_config) ? ($mail_config->smtp_status == 1 ? 'checked' : '') : 'checked' }}>
                            <label class="form-check-label" for="inlineRadio1">{{ trans('message.active_label') }}</label>

                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="smtp_status" id="inlineRadio1"
                                value="0" {{ isset($mail_config) ? ($mail_config->smtp_status == 0 ? 'checked' : '') : '' }}>
                    ...
                    <div class="col-12">
                        ...
                        <a href="{{ route('admin.basic_setting.mail_config') }}"
            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    ...
                    <div class="col-md-8">
                        ...
                        <span class="text-danger error_form" id="to_mail_error"></span>
